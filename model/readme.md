...
- **Backbone**: Custom CNN or pre-trained YOLO/RetinaNet (not specified explicitly)
...
- **Framework**: PyTorch / TensorFlow (based on your actual implementation)
- **Training Epochs**: Configurable
- **Batch Size**: Configurable
- **Learning Rate**: Configurable with decay scheduling
